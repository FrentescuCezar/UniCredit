        ...
        <div className="main-color-gray">
            ...
            <footer className="footer mt-auto py-4">
                <div className="container d-flex flex-wrap justify-content-between align-items-center main-color-gray">
                    <p className="col-md-4 mb-0 text-black">@ FIIPractic - UniCredit - 2024</p>
                    <ul className="nav navbar-dark  col-md-4 justify-content-end">
                        ...
                        <li className="nav-item">
                            <a href="linkedin.com/in/frentescu-cezar" target="_blank" className="nav-link px-2 text-black">
                                Linkedin
                            </a>
                        </li>
                    </ul>
